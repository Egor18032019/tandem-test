...
public interface IStringRowsListSorter {
    ...
    /**
     * Сортирует переданный список записей (каждая запись - набор колонок String[])
     ...
     *  <li>сортировка должна быть
     *  устойчива к исходной сортировке списка
     *  - т.е.,если строки (в контексте указанных правил сравнения) неразличимы,
